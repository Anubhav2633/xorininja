...
var FakeBackendInterceptor = /** @class */ (function () {
    ...
    FakeBackendInterceptor.prototype.intercept = function (request, next) {
        var users = [
            { id: 1, username: 'goyal_m', password: '1234', firstName: 'Mohit', lastName: 'Goyal', role: _models__WEBPACK_IMPORTED_MODULE_4__["Role"].Admin },
            { id: 2, username: 'jain_r', password: '1234', firstName: 'Rahul', lastName: 'Jain', role: _models__WEBPACK_IMPORTED_MODULE_4__["Role"].User }
        ];
        ...
        var role = roleString ? _models__WEBPACK_IMPORTED_MODULE_4__["Role"][roleString] : null;
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function () {
            ...
            if (request.url.match(/\/users\/\d+$/) && request.method === 'GET') {
                ...
                if (id_1 !== currentUser.id && role !== _models__WEBPACK_IMPORTED_MODULE_4__["Role"].Admin)
                    return unauthorised();
            ...
            if (request.url.endsWith('/users') && request.method === 'GET') {
                if (role !== _models__WEBPACK_IMPORTED_MODULE_4__["Role"].Admin)
                    return unauthorised();
                return ok(users);
            }
...
var AdminComponent = /** @class */ (function () {
    function AdminComponent(userService, authenticationService, httpService) {
        ...
        this.labels = ['Rupesh', 'Divya', 'Suyog', '2017', '2018', '2019'];
        this.chartData = [
            {
                data: [], label: 'Bilable'
            },
            {
                data: [], label: 'Non Bilable',
            }
        ];
        this.colors = [
            {
        ...
        this.barChartLebels = ['Rupesh', 'Divya', 'Suyog', '2017', '2018', '2019'];
        this.barChartType = 'bar';
        this.barChartLegand = true;
        // public barChartData = [
        //   {data : [120, 200, 150, 30, 50, 90], label : 'Bilable'},
        //   {data : [180, 160, 70, 40, 120, 90], label : 'Non Bilable'}
        //   // {data : [20, 70, 140, 100, 160, 180], label : 'Leave'}
        // ];    
        this.url = 'https://my-json-server.typicode.com/Anubhav2633/database/';
        this.options = [
            ...
            new _models_teams__WEBPACK_IMPORTED_MODULE_3__["Teams"]("UAT", 'KPMG UAT')
        ];
...
/* harmony import */ var _respoool_respoool_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./respoool/respoool.component */ "./src/app/respoool/respoool.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _admin__WEBPACK_IMPORTED_MODULE_10__["AdminComponent"],
                ...
                _respoool_respoool_component__WEBPACK_IMPORTED_MODULE_13__["RespooolComponent"],
            ],
            providers: [
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"], useClass: _helpers__WEBPACK_IMPORTED_MODULE_6__["JwtInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"], useClass: _helpers__WEBPACK_IMPORTED_MODULE_6__["ErrorInterceptor"], multi: true },
...
/* harmony import */ var _respoool_respoool_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./respoool/respoool.component */ "./src/app/respoool/respoool.component.ts");
...
var appRoutes = [
    ...
    {
        path: 'respool',
        component: _respoool_respoool_component__WEBPACK_IMPORTED_MODULE_7__["RespooolComponent"],
        canActivate: [_guards__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
...
module.exports = "<h1>Hi <strong>{{currentUser.firstName}}</strong></h1>\n<p>Your current utilization is.</p>\n<div>\n        <!-- <div>\n            <canvas baseChart\n                [data]= \"pieChartData\"\n                [labels]=\"pieChartLebels\"\n                [chartType]= \"pieChartType\">\n            </canvas>\n              </div> -->\n              <div>\n                <canvas\n                    baseChart\n                    [chartType]=\"'pie'\"\n                    [datasets]=\"pieChartData\"\n                    [labels]=\"pieChartLabels\"\n                    [options]=\"pieChartOptions\"\n                    [legend]=\"true\"\n                    [colors]=\"pieChartColor\"></canvas>\n              </div>\n</div>"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(userService, authenticationService, httpService) {
        this.userService = userService;
        this.authenticationService = authenticationService;
        this.httpService = httpService;
        this.url = 'https://my-json-server.typicode.com/Anubhav2633/database/';
        ...
        this.pieChartLabels = ['Total Engineering Hours', 'Daily Task', 'Training', 'Leave'];
        this.pieChartColor = [
            {
                backgroundColor: ['rgba(30, 169, 224, 0.8)',
                    'rgba(255,165,0,0.9)',
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.httpService.get(this.url + this.currentUser.firstName).subscribe(function (data) {
...
module.exports = "<!-- <table class=\"table table-striped\">\n    <ejs-grid [dataSource]='data'  [allowSorting]='true' [allowFiltering]='true'\n    [filterSettings]='filterSettings' >\n      <e-columns>\n        <e-column field='OrderID' headerText='Order ID' textAlign='Right' width='120'></e-column>\n        <e-column field='CustomerID' headerText='Customer ID' width='120'></e-column>\n        <e-column field='Freight' textAlign='Right' format='c2' width='120'></e-column>\n        <e-column field='ShipCountry' headerText='Ship Country' width='140'></e-column>\n      </e-columns>\n    </ejs-grid>\n</table> -->\n<table class=\"table table-hover\">\n    <thead>\n      <tr>\n        <th scope=\"col\">#</th>\n        <th  class=\"text-nowrap\" scope=\"col\">Project Name</th>\n        <th style=\"width: 100%;\" scope=\"col\">Team</th>\n        <th style=\"width: 100%;\" scope=\"col\">Description</th>\n        <th  scope=\"col\">Download</th>\n      </tr>\n    </thead>\n    <tbody>\n      <tr>\n        <th scope=\"row\">1</th>\n        <td>ExportToExcel</td>\n        <td>Alpha</td>\n        <td class=\"text-nowrap\">This applications export Excel files</td>\n        <td>\n            <a href=\"https://code-hackathon.s3.ap-south-1.amazonaws.com/Repository/Hackathon_trial.zip\">\n              <button  data-toggle=\"tooltip\" title=\"Click to download the latest repository\" class=\"btn\"><i class=\"fa fa-download\"></i> Download</button>\n             </a> \n         </td>\n      </tr>\n      <tr>\n        <th scope=\"row\">2</th>\n        <td>WPF</td>\n        <td>Beta</td>\n        <td class=\"text-nowrap\">This is windows form application</td>\n        <td>\n            <a  href=\"https://code-hackathon.s3.ap-south-1.amazonaws.com/Repository/Hackathon_trial.zip\">\n              <button data-toggle=\"tooltip\" title=\"Click to download the latest repository\" class=\"btn\"><i class=\"fa fa-download\"></i> Download</button>\n             </a>\n           </td>\n      </tr>\n      <tr>\n        <th scope=\"row\">3</th>\n        <td>AzureApps</td>\n        <td>Gamma</td>\n        <td class=\"text-nowrap\">This is a POC of azure app</td>\n        <td>\n            <a href=\"https://code-hackathon.s3.ap-south-1.amazonaws.com/Repository/Hackathon_trial.zip\">\n          <button  data-toggle=\"tooltip\" title=\"Click to download the latest repository\" class=\"btn\"><i class=\"fa fa-download\"></i> Download</button>\n            </a>\n        </td>\n      </tr>\n    </tbody>\n  </table>\n<p></p>\n<p></p>\n<p></p>\n<p></p>\n  <div>\n  <input type=\"file\" name=\"photo\" ng2FileSelect [uploader]=\"uploader\" />\n\n  <button type=\"button\" class=\"btn btn-success btn-s\" \n    (click)=\"uploader.uploadAll()\" \n    [disabled]=\"!uploader.getNotUploadedItems().length\" >\n        <a> Upload Project</a>\n  </button>\n</div>"
...
var ProjectComponent = /** @class */ (function () {
    function ProjectComponent(http, route, router) {
        this.http = http;
        this.route = route;
        this.router = router;
        this.URL = 'http://localhost:3000/api/upload';
        this.uploader = new ng2_file_upload__WEBPACK_IMPORTED_MODULE_1__["FileUploader"]({ url: this.URL, itemAlias: 'Project' });
    }
...
/***/ "./src/app/respoool/respoool.component.css":
/*!*************************************************!*\
  !*** ./src/app/respoool/respoool.component.css ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/app/respoool/respoool.component.html":
/*!**************************************************!*\
  !*** ./src/app/respoool/respoool.component.html ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./src/app/respoool/respoool.component.ts":
/*!************************************************!*\
  !*** ./src/app/respoool/respoool.component.ts ***!
  \************************************************/
/*! exports provided: RespooolComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RespooolComponent", function() { return RespooolComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var RespooolComponent = /** @class */ (function () {
    function RespooolComponent() {
    }
    RespooolComponent.prototype.ngOnInit = function () {
    };
    RespooolComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-respoool',
            template: __webpack_require__(/*! ./respoool.component.html */ "./src/app/respoool/respoool.component.html"),
            styles: [__webpack_require__(/*! ./respoool.component.css */ "./src/app/respoool/respoool.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], RespooolComponent);
    return RespooolComponent;
}());
